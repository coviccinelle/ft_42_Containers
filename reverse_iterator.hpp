...
/*   Updated: 2023/03/03 22:59:18 by thi-phng         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	template< class Iterator >
		class reverse_iterator
		{
			...
			public:
				...
				template< class U > 	reverse_iterator( const reverse_iterator<U>& other ) : _it(other.base()) {}
				...
				//	operator	reverse_iterator<iterator_type<value_type const> >() const 	{return (reverse_iterator<iterator_type<value_type const> >(_ptr));}
				//	operator	reverse_iterator<iterator_type<value_type> >() 	{return (reverse_iterator<iterator_type<value_type> >(_ptr));}
	...
	template< class Iterator>
		reverse_iterator<Iterator> operator+ (typename reverse_iterator<Iterator>::difference_type n, const reverse_iterator<Iterator>& rev_it) {return (rev_it.base() + n);}
